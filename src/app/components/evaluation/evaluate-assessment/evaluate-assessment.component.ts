...
export class EvaluateAssessmentComponent implements OnInit, OnDestroy {
  clickedData: any = {};
    ...
    this.evaluationService.clickedData$
      ...
      .subscribe((data) => {
        ...
        if (this.clickedData && this.clickedData.quizId) {
          ...
          this.evaluationList = []; //reset the data if clicked data is null
  ...
  getEvaluationDataByQuizId(quizId: string): void {
    console.log('Fetching data for quiz ID:', quizId);
    this.isLoading = true;
