...
//     // Automatically evaluate the single_answer and multi_answer questions if isAutoEvaluate is true
//     if (this.clickedData.isAutoEvaluate) {
//       this.clickedData.questions.forEach((question: any) => {
//         if (question.question_type === 'single_answer') {
//           // Automatically calculate marks for single-answer questions
...
//       // Calculate total marks and determine pass/fail
//       this.calculateTotalMarks();
      
//       // Set result as Pass or Fail based on marks
//       const percentage = (this.clickedData.marksScored / this.clickedData.totalMarks) * 100;
//       this.clickedData.result = percentage >= 60 ? 'Pass' : 'Fail';
//     }
//   }

//   onSubmit(): void {
//     // Only if isAutoEvaluate is false, allow manual scoring of descriptive questions
//     if (!this.clickedData.isAutoEvaluate) {
//       this.clickedData.questions.forEach((question: any) => {
//         if (question.question_type === 'descriptive') {
//           // Directly assign the marks for descriptive questions
...
//     // After evaluation (including descriptive questions), check pass/fail and update result
//     const percentage = (this.clickedData.marksScored / this.clickedData.totalMarks) * 100;
//     this.clickedData.result = percentage >= 60 ? 'Pass' : 'Fail';
//   }
